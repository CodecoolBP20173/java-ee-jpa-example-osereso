...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        phoneNumbers.add("012345678");
        phoneNumbers.add("0133456700");
        phoneNumbers.add("013883336700");
        ...
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, address, null);
